      ...
      <section className="relative min-h-[90vh] flex items-center overflow-hidden">
        ...
        <div className="relative z-10 mx-auto max-w-[1600px] px-6 md:px-10 w-full">
          ...
          <p className="text-base md:text-lg lg:text-xl text-paper-300/80 dark:text-paper-300/70 max-w-2xl font-light leading-relaxed">
            I work as a multi-disciplinary designer specializing in UI/UX prototyping, CAD modeling, software development, and spatial design. My portfolio brings together physical wellness hardware, immersive VR, and custom systems where deep research meets technical execution.
          </p>
        </motion.div>
        </div>
      </section>
